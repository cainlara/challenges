...
public class ASum {
  ...
  public static long findNb(long m) {
    ...
    while (accumulatedVolume < m) {
      level++;
      long currentLevelVolume = level * level * level;
      accumulatedVolume = accumulatedVolume + currentLevelVolume;
    }

    return accumulatedVolume == m ? level : -1;
  }
}
